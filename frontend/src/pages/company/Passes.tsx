...
export function CompanyPassesPage() {
  ...
  const rejectMutation = useMutation({
    mutationFn: (id: number) => passesApi.reject(id, 'Rejected'),
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ['passes'] }),
  })
  ...
  const columns: ColumnDef<VisitorPass>[] = [
    ...
    { accessorKey: 'host_employee_name', header: 'Host' },
  ...
  return (
    <div>
      <PageHeader title="Visitor Passes" description="Manage visitor passes for your company" />
